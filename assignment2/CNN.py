...
#2.完成卷积层反向传播conv_backward_naive
...
#6.完成cnn.py
#sanity check：若用softmax,我们期望随机参数的loss(无正则化项)应该是log(C)C是分类数
...
for param_name in sorted(grads):
  ...
  e=rel_error(grads[param_name],param_grad_num)
...
#完成spatial BN：用于对输入四维图像进行Batch normalization
'''N, C, H, W = 2, 3, 4, 5
